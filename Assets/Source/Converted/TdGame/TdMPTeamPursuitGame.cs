...
public partial class TdMPTeamPursuitGame : TdMPTeamGame/*
	...
	public virtual InitialTeamSpawn_del InitialTeamSpawn { get => bfield_InitialTeamSpawn ?? ((_a)=>{}); set => bfield_InitialTeamSpawn = value; } InitialTeamSpawn_del bfield_InitialTeamSpawn;
	public virtual InitialTeamSpawn_del global_InitialTeamSpawn => (_a)=>{};
	
	public delegate void TeamRespawnTimer_del(int TeamIndex);
	public virtual TeamRespawnTimer_del TeamRespawnTimer { get => bfield_TeamRespawnTimer ?? ((_a)=>{}); set => bfield_TeamRespawnTimer = value; } TeamRespawnTimer_del bfield_TeamRespawnTimer;
	public virtual TeamRespawnTimer_del global_TeamRespawnTimer => (_a)=>{};
