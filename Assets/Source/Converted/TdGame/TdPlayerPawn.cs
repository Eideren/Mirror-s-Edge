...
public partial class TdPlayerPawn : TdPawn/*
	...
	public /*transient */bool bPlayerDiedHoldingTheBag;
	public bool bIsInShadowAlteringMoveState;
	public/*()*/ bool bEnableHairPhysics;
	...
	public /*export editinline */AudioComponent WindSound;
	public SoundCue WindSoundSC;
	public /*export editinline */AudioComponent FallingSound;
	public/*(Movement)*/ /*config */float VertigoEdgeProbingHeight;
	public/*(Movement)*/ /*config */float VertigoEdgeProbingDistance;
	public/*(Movement)*/ /*config */float VertigoEffectThreshold;
	public/*(Movement)*/ /*config */float EdgeCheckMaxSpeed;
	public/*(Movement)*/ /*config */float EdgeCheckDistance;
	public/*(Movement)*/ /*config */float EdgeStopMinHeight;
	public /*transient */float LastEnemyHitTimeOut;
	public/*(Sounds)*/ TdReverbVolume CurrentReverbVolume;
	public /*transient */float ReverbVolumeTimer;
	public/*(Sounds)*/ /*config */float ReverbVolumePollTime;
	public/*(Sounds)*/ /*config */float OcclusionDuckLevel;
	public/*(Sounds)*/ /*config */float OcclusionDuckFadeTime;
	public /*transient */int IndoorSoundGroupIndex;
	public /*transient */array<int> OutdoorSoundGroupIndexes;
	public /*transient */int IndoorMixGroupIndex;
	public /*transient */int OutdoorMixGroupIndex;
	public /*transient */TdCarriable CarriedObject;
	public /*const config */float MovementStringAllowedGap;
	public /*transient */float MovementStringGapTimer;
	public /*transient */array< Class > MovementStringHistory;
	public /*const config */float PlayerBulletDamageMultiplier;
	public /*transient */Object.Vector FocusLocation;
	public /*private */Object.Vector PlayerCameraLocation;
	public /*private */Object.Rotator PlayerCameraRotation;
	public /*transient */array<name> HairBones;
	public int DebugPlayerGraph;
	public float LastDebugGraphValue;
	public int SimulatedBadFPS;
	public /*config */float FocusLocationInterpolationSpeed;
	...
	public virtual /*simulated function */void ForceDropBag(/*optional */Object.Vector Force = default)
	{
	...
	public /*event */void TdPlayerPawn_TakeDamage(int Damage, Controller InstigatedBy, Object.Vector HitLocation, Object.Vector damageMomentum, Core.ClassT<DamageType> DamageType, /*optional */Actor.TraceHitInfo HitInfo = default, /*optional */Actor DamageCauser = default)
	{
	...
	public override /*simulated function */void SetHipsOffset(Object.Vector Offset, /*optional */float BlendTime = default, /*optional */bool bFirstPersonMeshOnly = default)
	{
		BlendTime = 0.30f;
	...
	public virtual /*simulated function */void EnableFootPlacement(/*optional */float BlendTime = default)
	{
		BlendTime = 0.20f;
	...
	protected /*simulated event */bool TdPlayerPawn_UncontrolledFall_SetMove(TdPawn.EMovement NewMove, /*optional */bool bViaReplication = default, /*optional */bool bCheckCanDo = default)// state function
	{
