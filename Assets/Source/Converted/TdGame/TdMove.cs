...
public partial class TdMove : Object/*
	...
	public virtual /*final simulated event */void SetPreciseLocation(Object.Vector PreciseLocationToReach, TdMove.EPreciseLocationMode InterpMode, /*optional */float PreciseLocationSpeedToUse = default)
	{
		PreciseLocationSpeedToUse = -1.0f;
	...
	public virtual /*native final simulated function */bool MovementTrace(ref Object.Vector HitLocation, ref Object.Vector HitNormal, Object.Vector End, Object.Vector Start, Object.Vector Extent, /*optional */bool FindClosest = default)
	{
		#warning NATIVE FUNCTION !
		return default;
	}
	...
	public virtual /*final simulated function */void SetLookAtTargetLocation(Object.Vector Target, float InterpolationTime, /*optional */float Duration = default)
	{
		Duration = -1.0f;
	...
	public virtual /*final simulated function */void SetLookAtTargetAngle(Object.Rotator Target, float InterpolationTime, /*optional */float Duration = default)
	{
		Duration = -1.0f;
	...
	public virtual /*simulated function */void StopMove()
	{
		...
		PawnOwner.SetRootOffset(vect(0.0f, 0.0f, 0.0f), 0.30f, ((SkelControlBase.EBoneControlSpace)default(SkelControlBase.EBoneControlSpace)));
	...
	public virtual /*final simulated function */void PlayMoveAnim(TdPawn.CustomNodeType Type, name AnimName, float Rate, float BlendInTime, float BlendOutTime, /*optional */bool bRootMotion = default, /*optional */bool bRootRotation = default)
	{
		bRootMotion = false;
		bRootRotation = false;
	...
	public virtual /*function */bool CanStand(Object.Vector Location, /*optional */bool bFromAbove = default)
	{
