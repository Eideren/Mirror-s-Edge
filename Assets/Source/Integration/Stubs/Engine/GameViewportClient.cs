...
public partial class GameViewportClient : Object/* within Engine*//*
	...
	[native, Const, noexport] public/*private*/ Object.Pointer VfTable_FViewportClient;
	[native, Const, noexport] public/*private*/ Object.Pointer VfTable_FExec;
	[Const] public Object.Pointer Viewport;
	[Const] public Object.Pointer ViewportFrame;
	[init] public array</*init */Interaction> GlobalInteractions;
	public Core.ClassT<UIInteraction> UIControllerClass;
	public UIInteraction UIController;
	public Console ViewportConsole;
	[Const] public Object.QWord ShowFlags;
	[Const, localized] public String LoadingMessage;
	[Const, localized] public String SavingMessage;
	[Const, localized] public String ConnectingMessage;
	[Const, localized] public String PausedMessage;
	[Const, localized] public String PrecachingMessage;
	public bool bShowTitleSafeZone;
	[transient] public bool bDisplayingUIMouseCursor;
	[transient] public bool bUIMouseCaptureOverride;
	...
	[Const] public GameViewportClient.ESplitScreenType Default2PSplitType;
	[Const] public GameViewportClient.ESplitScreenType Default3PSplitType;
	[config] public Object.Vector2D SubtitleMinRegion;
	[config] public Object.Vector2D SubtitleMaxRegion;
