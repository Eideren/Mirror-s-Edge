...
public partial class SeqEvent_RigidBodyCollision : SequenceEvent/*
		native
		hidecategories(Object)*/{
	[Category] public float MinCollisionVelocity;
	
	public SeqEvent_RigidBodyCollision()
	{
		// Object Offset:0x003DCE31
		bPlayerOnly = false;
