...
public partial class UIAction_GetCellValue : UIAction_DataStore/*
	...
	public UIAction_GetCellValue()
	{
		// Object Offset:0x004077EB
		CollectionIndex = -1;
		bCallHandler = false;
		...
		VariableLinks = new array<SequenceOp.SeqVarLink>
		{
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkDesc = "Index",
				LinkVar = (name)"None",
				PropertyName = (name)"CollectionIndex",
				bWriteable = false,
				bHidden = false,
				MinVars = 1,
				MaxVars = 1,
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkDesc = "Markup",
				LinkVar = (name)"None",
				PropertyName = (name)"CellFieldMarkup",
				bWriteable = true,
				bHidden = false,
				MinVars = 1,
				MaxVars = 255,
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkVar = (name)"None",
				PropertyName = (name)"CellFieldStringValue",
				bWriteable = true,
				bHidden = true,
				MinVars = 1,
				MaxVars = 255,
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkVar = (name)"None",
				PropertyName = (name)"CellFieldImageValue",
				bWriteable = true,
				bHidden = true,
				MinVars = 1,
				MaxVars = 255,
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkVar = (name)"None",
				PropertyName = (name)"CellFieldRangeValue",
				bWriteable = true,
				bHidden = true,
				MinVars = 1,
				MaxVars = 255,
