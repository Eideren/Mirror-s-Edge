...
public partial class UIAction_FindPageByIndex : UIAction_GetPageReference/*
		hidecategories(Object)*/{
	[Category] public int SearchIndex;
	...
	public UIAction_FindPageByIndex()
	{
		...
		VariableLinks = new array<SequenceOp.SeqVarLink>
		{
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkDesc = "Tab Page",
				LinkVar = (name)"None",
				PropertyName = (name)"PageReference",
				bWriteable = true,
				bHidden = false,
				MinVars = 1,
				MaxVars = 255,
