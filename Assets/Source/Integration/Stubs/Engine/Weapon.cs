...
public partial class Weapon : Inventory/*
	...
	[Category] public array<float> FireInterval;
	[Category] public array<float> Spread;
	[Category] public array<float> InstantHitDamage;
	[Category] public array<float> InstantHitMomentum;
	public array< Core.ClassT<DamageType> > InstantHitDamageTypes;
	[Category] public float EquipTime;
	[Category] public float PutDownTime;
	[Category] public Object.Vector FireOffset;
	public bool bWeaponPutDown;
	public bool bCanThrow;
	public bool bInstantHit;
	public bool bMeleeWeapon;
	[Category] public float WeaponRange;
	[Category] public float ClothImpulseRadius;
	[Category] public float ClothImpulseScale;
	[Category] [export, editinline] public MeshComponent Mesh;
	[Category] public float DefaultAnimSpeed;
	[databinding, config] public float Priority;
