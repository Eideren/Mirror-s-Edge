...
public partial class UIDataStore_TdTimeTrialData : UIDataStore_TdGameResource/*
	...
	[Const] public array<name> StretchIdMapping;
	[config] public int WeeklyGhostCutoffRank;
	[config] public int MonthlyGhostCutoffRank;
	[transient] public TdTTInput TTOfflineInput;
	[transient] public TdTTInput TTOnlineInput;
	[transient] public TdTTResult TTOfflineResult;
	[transient] public TdTTResult TTOnlineResult;
