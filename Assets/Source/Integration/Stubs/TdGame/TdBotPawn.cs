...
public partial class TdBotPawn : TdPawn/*
	...
	{
		[Category("DeathAnim")] public name AnimName;
		[Category("DeathAnim")] public float PlaybackSpeed;
		[Category("DeathAnim")] public bool bUseRootMotion;
		[Category("DeathAnim")] public float PawnImpulse;
		[Category("DeathAnim")] public float PawnZImpulse;
		[Category("DeathAnim")] public float BoneImpulse;
		[Category("DeathAnim")] public float GravityModifier;
		[Category("DeathAnim")] public float CollisionScale;
		[Category("DeathAnim")] public bool bUseMotors;
		[Category("DeathAnim")] public float MotorStrength;
		[Category("DeathAnim")] public float TimeToEnableRagdoll;
		[Category("DeathAnim")] public float TimeToBlendOutMotors;
		[Category("DeathAnim")] public float TimeToDisableMotors;
		[Category("DeathAnim")] public float TimeToBoneImpulse;
		[Category("DeathAnim")] public float TimeToFullRagdoll;
	...
	[Category("BotConfig")] public bool bImmobile;
	...
	[config] public bool bDebugDeathAnim;
	...
	[transient] public bool bEnableMeleePose;
	public bool bIsAccelerating;
	[transient] public bool bEnableInverseKinematics;
	public bool bHeadPitchAlwaysOk;
	public bool bCanFire;
	[transient] public/*private*/ bool bIsRunnerVisionEnabled;
	[transient] public/*private*/ bool bPawnRunnerVision;
	...
	[config] public float LegOffsetWalkFwd;
	[config] public float LegOffsetWalkLeft60;
	[config] public float LegOffsetWalkLeftBwd120;
	[config] public float LegOffsetWalkRight60;
	[config] public float LegOffsetWalkRightBwd120;
	[config] public float LegOffsetWalkBack;
	[config] public float LegOffsetRunFwd;
	[config] public float LegOffsetRunLeft90;
	[config] public float LegOffsetRunLeft180;
	[config] public float LegOffsetRunRight90;
	[config] public float LegOffsetRunRight180;
	[Const] public float CMaxPathDistSq;
	...
	[transient] public TdPawn.EWeaponAnimState AiInitializeWeaponAnimationState;
	public TdBotPawn.DeathAnimData DeathAnim;
	[Category("DeathAnim")] [config] public TdBotPawn.DeathAnimData DeathAnimRagdoll;
	[Category("DeathAnim")] [config] public TdBotPawn.DeathAnimData DeathAnimRagdollHard;
	[Category("DeathAnim")] [config] public TdBotPawn.DeathAnimData DeathAnimDeathFront;
	[Category("DeathAnim")] [config] public TdBotPawn.DeathAnimData DeathAnimDeathFrontHard;
	[Category("DeathAnim")] [config] public TdBotPawn.DeathAnimData DeathAnimDeathBack;
	[Category("DeathAnim")] [config] public TdBotPawn.DeathAnimData DeathAnimDeathBackHard;
	[Category("DeathAnim")] [config] public TdBotPawn.DeathAnimData DeathAnimDeathRight;
	[Category("DeathAnim")] [config] public TdBotPawn.DeathAnimData DeathAnimDeathRightHard;
	[Category("DeathAnim")] [config] public TdBotPawn.DeathAnimData DeathAnimDeathLeft;
	[Category("DeathAnim")] [config] public TdBotPawn.DeathAnimData DeathAnimDeathLeftHard;
	[Category("DeathAnim")] [config] public TdBotPawn.DeathAnimData DeathAnimDeathByAuto;
	public array<name> RagdollBones;
	public float RagdollMotorBlendOut;
	public float RagdollTimer;
	[Category] public/*private*/ SoundCue BodyFallHard;
	[Category] public/*private*/ SoundCue BodyFallMedium;
	[Category] public/*private*/ SoundCue BodyFallSoft;
	[Category("BotControl")] [config] public int AccelRateNormal;
	[Category("BotControl")] [config] public int AccelRateFast;
	public float CertainSightRadius;
	[Category] public int CurrentBurstLength;
	[Category] public float BurstDelayMin;
	[Category] public float BurstDelayMax;
	[Category] public int CurrentBurstMin;
	[Category] public int CurrentBurstMax;
	...
	[transient] public int MainWeaponAmmo_Dropped;
	[transient] public int MainWeaponAmmo_Disarmed;
	[transient] public/*private*/ int FactoryAmmoDrop_Easy;
	[transient] public/*private*/ int FactoryAmmoDrop_Medium;
	[transient] public/*private*/ int FactoryAmmoDrop_Hard;
	[transient] public/*private*/ int FactoryAmmoDisarm_Easy;
	[transient] public/*private*/ int FactoryAmmoDisarm_Medium;
	[transient] public/*private*/ int FactoryAmmoDisarm_Hard;
	...
	[Category("AIMovement")] [config] public int MaxLookAhead;
	[Category("AIMovement")] [config] public int DiffForMaxRotationSpeed;
	[Category("AIMovement")] [config] public int MaxRotationSpeed;
	[Category("AIMovement")] [config] public int MaxRotationAcceleration;
	[Category("AIMovement")] [config] public int MinRotationAcceleration;
	[Category("AIMovement")] [config] public int RotationSpeedDiffForMaxAcceleration;
	[Category("AIMovement")] [config] public int TurnFrictionTweak;
	[Category("AIMovement")] [config] public float RotationSpeedForMaxLean;
	[Category("AccelerationTimes")] [config] public float WalkToRun;
	[Category("AccelerationTimes")] [config] public float RunToWalk;
	[Category("AccelerationTimes")] [config] public float StandToWalk;
	[config] public float DamageTime;
	[transient] public int MeleeAttackLimit;
	[transient] public int ConsecutiveHitCount;
	[transient] public int ConsecutiveCrouchHitCount;
	[transient] public int ConsecutiveAirHitCount;
	[transient] public float MeleeAttackTime;
	[transient] public float CrouchMeleeAttackTime;
	[transient] public float AirMeleeAttackTime;
	[config] public float BlockResetTime;
	public float InterpolatedSlope;
	[transient] public TdBotPawn.EaseStructure InterpolationInformation;
	[transient] public name AiProfileName;
	[transient] public float AnimationRunSpeed;
	[transient] public float AnimationWalkSpeed;
	[transient] public float AnimationExitReloadTime;
	public float StartFallingZ;
	public Object.Vector StartingLocation;
	public Object.Rotator StartingRotation;
	[export, editinline, transient] public SkeletalMeshComponent AdditionalSkeletalMesh;
