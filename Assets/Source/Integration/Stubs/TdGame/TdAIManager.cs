...
public partial class TdAIManager : Actor/*
	...
	[Category("AIManager")] public bool UseBurstControl;
	[Category("AIManager")] public bool UseBulletControl;
	...
	[Category("AIManager")] public int MaxShotsFiredPerFrame;
	public int ShotsFiredThisSecond;
	[Category("AIManager")] public int MaxShotsFiredPerSecond;
	public float CurrentMeasuringSecond;
	public float LastShotFiredTimeStamp;
	public int NumCleanFramesSinceLastShotFired;
	[Category("AIManager")] public int MaxNumCleanFrames;
