	...
	public UIAction_TdCreateGame()
	{
		...
		VariableLinks = new array<SequenceOp.SeqVarLink>
		{
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkDesc = "Level Name",
				LinkVar = (name)"None",
				PropertyName = (name)"startLevelName",
				bWriteable = false,
				bHidden = false,
				MinVars = 1,
				MaxVars = 255,
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkedVariables = default,
				LinkDesc = "Attempt Load",
				LinkVar = (name)"None",
				PropertyName = (name)"attemptLoad",
				bWriteable = false,
				bHidden = false,
				MinVars = 1,
				MaxVars = 255,
