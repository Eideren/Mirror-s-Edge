...
public partial class TdAIController : AIController, 
	...
	[transient] public TdAIAnimationController.ECoverDirectionState ForcedCoverDirection;
	...
	[transient] public bool bAllowFocus;
	[transient] public bool bAllowFocusRotation;
	...
	[transient] public bool bForceValidCoverDirection;
	...
	[transient] public bool bAnimationPlaybackInterrupted;
	...
	[Category("BotControl")] public bool bDoAimingLag;
	[Category("BotDebugging")] public bool bDrawAimingLines;
	[Category("Debug")] [config] public bool bAILogging;
	[Category("Debug")] [config] public bool bAILogToWindow;
	...
	[config] public bool bUseVoiceOver;
	public bool bMuted;
	...
	[Category] [editinline] public TdAimBotBase RealAimBot;
	...
	[Category("Suppression")] public float SuppressionRecoveryTime;
	[Category("Suppression")] public float SuppressionDeclineTime;
	[Category("Suppression")] public float SuppressionDistance;
	[Category("Suppression")] public float SuppressionFactorForDirectHit;
	public float Suppression;
	public/*private*/ float KeepFiringTime;
	[Category] public int RotationSpeedCFG;
	public Actor MoveGoal;
	public Object.Vector MovePoint;
	public Object.Vector PathfindingGoalPos;
	...
	[Const] public float AdvanceTime;
	...
	[Category("BotControl")] [config] public float BotAimingLag;
	[transient] public/*private*/ int DifficultyLevel;
	public float lastLogTime;
	public name lastLogStateName;
	public FileLog AILogFile;
	[config] public array</*config */name> AILogFilter;
	public int logTabs;
	[config] public array</*config */name> ScreenLogFilter;
	...
	public int voice;
	[Category("Melee")] [editinline] public TdMove_BotMelee BotMeleeMove;
