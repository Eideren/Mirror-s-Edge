...
public partial class GenericBrowserType_TdUIScene : GenericBrowserType_UIScene/*
		native
		hidecategories(Object,GenericBrowserType)*/{
	public GenericBrowserType_TdUIScene()
	{
		// Object Offset:0x000019AF
		Description = "TdUIScene";
	}
}
}