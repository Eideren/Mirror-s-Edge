...
public partial class TdMove_Landing
{
  public override unsafe void UpdateMoveTimer(float a2)
  {
    ...
    if(v3 != default)
    {
      ...
      v5 = sub_1117920(&v12, (wchar_t *)L"FXM_SoftlandingWaves_01", 1, 1);
      (*(void (__thiscall **)(MaterialInstance , int, int, float))(v4 + 364))(this.SoftLandingMaterialInstance, *v5, v5[1], COERCE_FLOAT(LODWORD(v11)));
    }
    v6 = this.Timer;
    v7 = a2;
    if ( v6 > 0.0f )
  ...
  public unsafe bool IsLandingOnSoftObject()
  {
    ...
    a5.Z = 5.0f;
    if ( default == this.MovementLineCheck(&a2, &a3, &a4, &a5, 9414) )
      return false;
    ...
    if ( default == v7 || (v7.bEnableSoftLanding.AsBitfield(4) & bEnableSoftLanding) == 0 )
      return false;
    SetFromBitfield(ref this.bForceLandBack, 2, this.bForceLandBack.AsBitfield(2) | (2u));
    v8 = E_TryCastTo<MaterialInstance>((int)v6);
    ...
    if ( default == v8 )
    {
      ...
      if(v9 != default)
      {
        v10 = v9.StaticMeshComponent.int( 0);// int.GetMaterial()
