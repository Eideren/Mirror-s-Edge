...
public partial class TdMove_Crouch
{
  public override unsafe void PrePerformPhysics(float DeltaTime)
  {
    SetFromBitfield(ref this.PawnOwner.bDisableSkelControlSpring, 32, this.PawnOwner.bDisableSkelControlSpring.AsBitfield(32) ^ ((this.PawnOwner.bDisableSkelControlSpring.AsBitfield(32) ^ (2u * (this.TestCanUnCrouch() ? 1u : 0u))) & 2u));
  }
}
}
