...
public partial class TdAnimNodeBlendDirectional : AnimNodeBlendBase/*
		native
		hidecategories(Object,Object,Object)*/{
	public Object.Vector2D Direction;
	public float DirInterpTime;
	public float ForwardInterpTime;
	...
	public override /*event */void OnBecomeRelevant()
	{
		...
		ForwardBlend = ((Direction.Y > 0.0f) ? 1.0f : 0.0f);
		bGoingForward = Direction.Y > 0.0f;
	}
	
	public TdAnimNodeBlendDirectional()
	{
		// Object Offset:0x004FF5FE
		DirInterpTime = 0.10f;
		ForwardInterpTime = 0.40f;
		ForwardBlend = 1.0f;
		bGoingForward = true;
