...
public partial class TdMove : Object/*
	...
	[Category] [Const, config] public float SpeedModifier;
	[Category] [Const, config] public float FrictionModifier;
	[Category] public bool bDebugMove;
	[Category] [Const, config] public bool bTriggersCompliment;
	[Const] public bool bDisableCollision;
	[Const] public bool bShouldHolsterWeapon;
	[Const] public bool bShouldUnzoom;
	[Const] public bool bIsTimedMove;
	public bool bConstrainLook;
	public bool bUseAbsoluteYawConstraint;
	[Const] public bool bDisableActorCollision;
	...
	[Const] public bool bAvoidLedges;
	[transient] public bool bUsePreciseLocation;
	[transient] public bool bReachedPreciseLocation;
	[Category] public bool bDebugPreciseLocation;
	[transient] public bool bUsePreciseRotation;
	[transient] public bool bReachedPreciseRotation;
	[transient] public bool bDelayRotationAndLocationCallback;
	public bool bResetCameraLook;
	public bool bUseCustomCollision;
	public bool bUseCameraCollision;
	[Category] public bool bTwoHandedFullBodyAnimations;
	...
	[Category] [Const, config] public/*private*/ TdMove.AIAimingModifierSettings AiAimPenalties;
	[Category] [Const, config] public/*private*/ TdMove.AIAimingModifierSettings AiAimOneShotPenalties;
	[transient] public float AiAimPenalty;
	[transient] public float AiAimOneShotPenalty;
	...
	[Const] public float DisableMovementTime;
	[Const] public float DisableLookTime;
	[transient] public float LastCanDoMoveTime;
	public float LastStopMoveTime;
	[transient] public float MoveActiveTime;
	[Const, config] public float RedoMoveTime;
	public float PreciseLocationSpeed;
	[transient] public Object.Vector PreciseLocation;
	public float PreciseRotationInterpolationTime;
	[transient] public Object.Rotator PreciseRotation;
	[transient] public Object.Vector LookAtTargetLocation;
	[transient] public Object.Rotator LookAtTargetAngle;
	...
	[Category] public Object.Vector RootOffset;
	[Category] public int SwanNeckEnableAtPitch;
	[Category] public float SwanNeckForward;
	[Category] public float SwanNeckDown;
	public name CurrentCustomAnimName;
	public AnimNodeSequence CurrentCustomAnimNode;
	[config] public name FireAnimSeqName;
	[config] public name ReloadAnimSeqName;
	public float AnimBlendTime;
	[Category("StickyAim")] [config] public int StickyAngle;
	[Category("StickyAim")] [config] public float StickyAimedModifier;
	public float Timer;
