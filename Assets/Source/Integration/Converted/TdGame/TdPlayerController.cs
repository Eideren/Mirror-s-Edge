...
public partial class TdPlayerController : GamePlayerController, 
	...
	[native, Const, noexport] public/*private*/ Object.Pointer VfTable_ITdController;
	public bool InfiniteAmmo;
	[config] public/*private*/ bool bDebugPostProcessFreeFlight;
	...
	[Category("Sounds")] [config] public bool bDebugSoundMixGroups;
	[Category("Sounds")] [config] public bool bDebugSoundVelocity;
	[Category("Sounds")] [config] public bool bDebugSoundReverbVolumes;
	[transient] public/*private*/ bool ControllerTilt;
	public/*private*/ bool VisualizeControllerTilt;
	public bool bRopeburnDisarmSucceeded;
	public float TimePressedJump;
	[config] public float JumpTapTime;
	[config] public float BagSearchTapTime;
	public float LastEmoteMessageTime;
	[config] public float AllowedEmoteMessageInterval;
	[transient] public/*private*/ Core.ClassT<TdLocalMessage> TdEmoteMessageClass;
	[transient] public TdPawn TargetingPawn;
	[transient] public float TargetingPawnInterp;
	[config] public float TargetingCutoffAngle;
	public TdPawn TargetPawn;
	public Actor TargetActor;
	public Object.Vector TargetActorLocation;
	[config] public float LookAtTimeDelay;
	...
	[transient] public TdPawn.WalkingState CachedWalkingState;
	[config] public float CloseCombatMinRange;
	[config] public float CloseCombatMaxRange;
	[config] public float CloseCombatRangeTime;
	[config] public float CloseCombatMaxAngle;
	[config] public float CloseCombatPawnDistanceBias;
	public float InputSize;
	[Category("Speed")] [config] public float InputMaxSprintRaduisLimit;
	[Category("Speed")] [config] public float InputMaxSprintHeightLimit;
	[Category("Speed")] [config] public float InputMaxWalkRadiusLimit;
	[Category("WallRunning")] [config] public float WallRunningAlignTime;
	public int WallRunningAlignYaw;
	public int LOIIndex;
	public float ReactionTimeEnergy;
	[Category("ReactionTime")] [Const, config] public float ReactionTimeSpawnLevel;
	[Category("ReactionTime")] [Const, config] public float ReactionTimeDrain;
	[Category("ReactionTime")] [Const, config] public float ReactionTimeMaxEffect;
	[Category("ReactionTime")] [Const, config] public float ReactionTimeFadeIn;
	[Category("ReactionTime")] [Const, config] public float ReactionTimeFadeOut;
	[Category("ReactionTime")] [transient] public float ReactionTimeEnergyBuildRate;
	[Const, config] public/*private*/ TdPlayerController.ReactionTimeSettings ReactionTimeBuildRates;
	[Category("WallClimbing")] [config] public float WallClimbingDodgeJumpThreshold;
	[Category("WallRunning")] [config] public float WallRunningDodgeJumpThreshold;
	[config] public float WalkCyclePart1;
	[config] public float WalkCyclePart2;
	[config] public float AccelerationTime;
	[config] public float StopAnimBlendIn;
	[config] public float StopAnimBlendOut;
	[config] public float StoppingVelocity;
	public array<TdPlayerController.LocalEnemy> LocalEnemies;
	public int NextLocalEnemyToCheckLOS;
	[transient] public float LastEnemyNetSendTime;
	public TdDebugOutput DebugOutput;
	public Object.Rotator VehicleRotation;
	public Object.Rotator DriverRotation;
	[Category("Team")] [config] public int Team;
	public TdPlayerPawn myPawn;
	public Actor StickyActor;
	[Category("StickyAim")] [config] public float StickySpeed;
	public float FOVZoomRate;
	[transient] public float FOVZoomDelay;
	public float MouseX;
	public float MouseY;
	...
	[transient] public/*protected*/ UIDataStore_TdTutorialData TutorialDataStore;
	[transient] public/*protected*/ UIDataStore_TdTimeTrialData TimeTrialDataStore;
	[transient] public/*protected*/ UIDataStore_TdStringAliasBindingsMap StringAliasBindingsMapStore;
	[transient] public/*protected*/ TdStatsManager StatsManager;
	[transient] public/*private*/ float ActualAccelX;
	[transient] public/*private*/ float ActualAccelY;
	[transient] public/*private*/ float ActualAccelZ;
	[config] public float SixAxisDisarmZ;
	[config] public float SixAxisDisarmY;
	[config] public float SixAxisRollZ;
	[config] public float SixAxisRollY;
	[transient] public float DisarmTimeMultiplier;
