...
public partial class TdSPTimeTrialGame : TdSPGame, 
	...
	[config] public/*private*/ int RaceFinishLineTime;
	[config] public/*private*/ float RaceFinishLineFadeTimePct;
	public/*private*/ float RaceFinishLineTimer;
	[config] public/*private*/ int RaceCountDownTime;
	public/*private*/ int RaceCountDownTimer;
	[transient] public/*private*/ TdPlaceableCheckpointManager CheckpointManager;
	[transient] public/*private*/ TdLookAtPoint CheckpointLookAtHelper;
	[transient] public/*private*/ TdPlaceableCheckpoint NextCheckPoint;
	[transient] public/*private*/ TdPlaceableCheckpoint LastCheckPoint;
	[transient] public int NumCheckPoints;
	[transient] public int NumPassedCheckPoints;
	[transient] public int NumPassedTimerCheckPoints;
	[transient] public/*private*/ float LastCheckpointTimeStamp;
	[transient] public/*private*/ TdPlayerPawn RacingPawn;
	[transient] public/*protected*/ TdPlayerController RacingPlayer;
	[transient] public/*private*/ Object.Vector LastValidPlayerLocation;
	[transient] public/*private*/ float LastPlayerResetTime;
	[transient] public byte bDelayPauseUntilRaceStarted;
	[transient] public TdSPTimeTrialGame.ETTStretch ActiveTTStretch;
	public/*protected*/ TdSPTimeTrialGame.ERaceType RaceType;
	[transient] public bool HasGhost;
	...
	[transient] public TdPlaceableCheckpointManager.TrackData CurrentTackData;
	[transient] public TdSPTimeTrialGame.TimeData CurrentTimeData;
	[transient] public TdSPTimeTrialGame.TimeData TimeDataToBeat;
	[transient] public float RaceStartTimeStamp;
	[transient] public float RaceEndTimeStamp;
	[transient] public float PlayerDistance;
	[transient] public/*private*/ Core.ClassT<TdLocalMessage> TdTTMessageClass;
	[transient] public/*private*/ Core.ClassT<TdVictoryMessage> VictoryMessageClass;
	[transient] public/*private*/ Core.ClassT<TdLocalMessage> TimeMessageClass;
	[transient] public/*private*/ Core.ClassT<TdLocalMessage> TimeFinishMessageClass;
