...
public partial class PlayerInput : Input/* within PlayerController*//*
	...
	[Const] public bool bUsingGamepad;
	[globalconfig] public bool bInvertMouse;
	[globalconfig] public bool bInvertTurn;
	...
	[globalconfig] public bool bEnableMouseSmoothing;
	public bool bEnableFOVScaling;
	[Const] public name LastAxisKeyName;
	public float DoubleClickTimer;
	[globalconfig] public float DoubleClickTime;
	[globalconfig] public float MouseSensitivity;
	[input] public float aBaseX;
	[input] public float aBaseY;
	[input] public float aBaseZ;
	[input] public float aMouseX;
	[input] public float aMouseY;
	[input] public float aForward;
	[input] public float aTurn;
	[input] public float aStrafe;
	[input] public float aUp;
	[input] public float aLookUp;
	[input] public float aPS3AccelX;
	[input] public float aPS3AccelY;
	[input] public float aPS3AccelZ;
	[input] public float aPS3Gyro;
	[transient] public float RawJoyUp;
	[transient] public float RawJoyRight;
	[transient] public float RawJoyLookRight;
	[transient] public float RawJoyLookUp;
	[Category] [config] public float MoveForwardSpeed;
	[Category] [config] public float MoveStrafeSpeed;
	[Category] [config] public float LookRightScale;
	[Category] [config] public float LookUpScale;
	[input] public byte bStrafe;
	[input] public byte bXAxis;
	[input] public byte bYAxis;
