...
using TdGame; using TdMenuContent; using TdMpContent; using TdSharedContent; using TdSpBossContent; using TdSpContent; using TdTTContent; using TdTuContent; using TdEditor;
	...
	public virtual /*function */void OnControllerChanged(int ControllerId, bool bIsConnected)
	{
		...
		if((WorldInfo.IsConsoleBuild(default(WorldInfo.EConsoleType?)) && LocPlayer != default) && LocPlayer.ControllerId == ControllerId)
		{
	...
	public virtual /*reliable server function */void ServerSetUniquePlayerId(OnlineSubsystem.UniqueNetId UniqueId, bool bWasInvited)
	{
		...
		if(!bPendingDestroy && !bReceivedUniqueId)
		{
			...
			{
				if(((WorldInfo.IsConsoleBuild(default(WorldInfo.EConsoleType?)) && WorldInfo.Game.GameSettings != default) && !WorldInfo.Game.GameSettings.bIsLanMatch) && UniqueId == ZeroId)
				{
					ClientWasKicked();
					Destroy();				
				}
	...
	(System.Action<name>, StateFlow, System.Action<name>) Spectating()/*state Spectating extends BaseSpectating*/
	{
		...
		System.Collections.Generic.IEnumerable<Flow> StateFlow(name jumpTo = default)
		{
			...
			/*ignores*/ RestartLevel = ()=>{}; ClientRestart = (_a)=>{}; Suicide = ()=>{}; ThrowWeapon = ()=>{};
	...
	(System.Action<name>, StateFlow, System.Action<name>) PlayerWaiting()/*auto state PlayerWaiting extends BaseSpectating*/
	{
		...
		System.Collections.Generic.IEnumerable<Flow> StateFlow(name jumpTo = default)
		{
			...
			/*ignores*/ TakeDamage = (_1,_2,_3,_4,_5,_6,_a)=>{}; NextWeapon = ()=>{}; PrevWeapon = ()=>{}; SwitchToBestWeapon = (_a)=>{}; Jump = ()=>{}; Suicide = ()=>{}; ServerSuicide = ()=>{};
	...
	(System.Action<name>, StateFlow, System.Action<name>) RoundEnded()/*state RoundEnded*/
	{
		...
		System.Collections.Generic.IEnumerable<Flow> StateFlow(name jumpTo = default)
		{
			/*ignores*/ KilledBy = (_a)=>{}; TakeDamage = (_1,_2,_3,_4,_5,_6,_a)=>{}; Suicide = ()=>{}; ServerRestartPlayer = ()=>{}; ThrowWeapon = ()=>{}; Use = ()=>{}; LongClientAdjustPosition = (_1,_2,_3,_4,_5,_6,_7,_8,_9,_10,_11,_12,_a)=>{};
	...
	(System.Action<name>, StateFlow, System.Action<name>) Dead()/*state Dead*/
	{
		...
		System.Collections.Generic.IEnumerable<Flow> StateFlow(name jumpTo = default)
		{
			/*ignores*/ KilledBy = (_a)=>{}; NextWeapon = ()=>{}; PrevWeapon = ()=>{}; ThrowWeapon = ()=>{};
	...
	public PlayerController()
	{
		...
		CylinderComponent = Default__PlayerController_CollisionCylinder/*Ref CylinderComponent'Default__PlayerController.CollisionCylinder'*/;
