...
public partial class TdWeapon : Weapon/*
	...
	public partial struct /*native */AIBurstInfo
	{
		...
		public/*()*/ float Pause_Min;
		public/*()*/ float Pause_Max;
	...
	public /*const */array<name> AimOffsetProfileNames;
	public /*const */name WeaponPoseProfileName;
	public/*()*/ Object.Rotator OneHandedRightShoulderRotationOffset;
	public/*()*/ Object.Vector OneHandedRightShoulderTranslationOffset;
	public/*()*/ Object.Vector weaponDrawOffset;
	public/*()*/ Object.Rotator weaponRotationOffset;
	...
	public/*(StickyAim)*/ /*config */bool bDebugStickyAim;
	public bool OverrideWeaponFireTypeForAI;
	public name ReloadingState;
	public/*()*/ /*config */Object.Vector WeaponDropAngularVelocity;
	public/*()*/ /*config */Object.Vector WeaponDropLinearVelocity;
	public/*()*/ /*config */int TimeThrownWeaponStaysInWorld;
	public/*(WeaponEffects)*/ TdAnimNodeSlot WeaponAnimationNode1p;
	public/*(WeaponEffects)*/ TdAnimNodeSlot WeaponAnimationNode3p;
	public/*(WeaponEffects)*/ /*export editinline */ParticleSystemComponent MuzzleFlashPSC;
	public/*(WeaponEffects)*/ ParticleSystem MuzzleFlashPSCTemplate;
	public name MuzzleFlashSocket;
	public/*(WeaponEffects)*/ ParticleSystem BulletTraceTemplate;
	public/*(WeaponEffects)*/ ParticleSystem ShellEjectPS;
	public name ShellEjectSocket;
	public float ShellEjectDelay;
	public /*transient */TdEmitter ShellEjectEmitter;
	public /*protected */ForceFeedbackWaveform FiringWaveform;
	public/*(Ammunition)*/ int MaxAmmo;
	public/*(Ammunition)*/ float StartReloadTime;
	public/*(Ammunition)*/ float ReloadTime;
	public/*(Ammunition)*/ float EndReloadTime;
	public/*(Ammunition)*/ int BurstMax;
	public int AmmoCount;
	public int BurstCnt;
	public int ClipCount;
	public /*protected */int PassThroughLimit;
	public/*()*/ array<float> InstantHitDamageMP;
	public /*const */Texture2D NormalCrossHair;
	public /*const */Texture2D OnTargetCrossHair;
	public /*const */Object.LinearColor OnTargetCrossHairColor;
	public/*()*/ array<bool> bAutomaticReFire;
	public/*()*/ array<bool> bStallReFire;
	public/*()*/ array<float> FireIntervalNoise;
	public /*transient */array<float> ActualFireIntervalNoise;
	public array<TdWeapon.EWeaponFallOffType> WeaponFallOffTypes;
	public/*()*/ float FallOffDistance;
	public /*config */int DeathAnimType;
	public /*private config */TdWeapon.FloatDifficultySettings FallOffDistances;
	public /*private config */TdWeapon.FloatDifficultySettings Ranges;
	public /*private config */TdWeapon.FloatDifficultySettings Damages;
	public/*(Speed)*/ float MovementRecoilWhenFire;
	public/*(Sounds)*/ array<SoundCue> WeaponFireSnd1p;
	public/*(Sounds)*/ array<SoundCue> WeaponReverbSnd1p;
	public/*(Sounds)*/ array<SoundCue> WeaponFireSnd3p;
	public/*(Sounds)*/ array<SoundCue> WeaponReverbSnd3p;
	public/*(Sounds)*/ SoundCue WeaponCollisionSnd;
	public/*(Sounds)*/ SoundCue WeaponClickSnd;
	public/*(Sounds)*/ SoundCue WeaponSlapBackSnd;
	public/*(Sounds)*/ int MaxNumberOfSlapBackRays;
	public/*(Sounds)*/ int NumberOfSlapBacks;
	public/*(Sounds)*/ int RangeOfSlapBackRays;
	public name OutOfAmmoAnimName;
	public TdPawn.EWeaponType WeaponType;
	public/*()*/ TdWeapon.EWeaponDecalType DecalTypeToUse;
	...
	public/*(AimAssist)*/ int MaxAssistDistance;
	public/*(AimAssist)*/ float AssistInnerRadius;
	public/*(AimAssist)*/ float AssistInnerHeight;
	public/*(AimAssist)*/ float MaxAssistValueYaw;
	public/*(AimAssist)*/ float MaxAssistValuePitch;
	public/*(AimAssist)*/ float StrafeAssistMultiplier;
	public/*(AimAssist)*/ float MaxAssistScaleDist;
	public/*(AimAssist)*/ float MaxAssistScaleVal;
	public/*(AimAssist)*/ float MinAssistScaleDist;
	public/*(AimAssist)*/ float MinAssistScaleVal;
	public/*(StickyAim)*/ /*config */float StickyAimModifier;
	public/*(StickyAim)*/ float StickyMaxDistance;
	public/*(StickyAim)*/ Actor StickyActor;
	public/*(StickyAim)*/ Object.Rotator StickyRotation;
	public /*config */float AIDamageMultiplier;
	public /*protected config */float CombatRange_Min;
	public /*protected config */float CombatRange_Max;
	public /*protected config */float CombatRange_Preferred;
	public/*(AISettings)*/ /*protected config */TdWeapon.AIBurstInfo AimedBurst_Near;
	public/*(AISettings)*/ /*protected config */TdWeapon.AIBurstInfo AimedBurst_Mid;
	public/*(AISettings)*/ /*protected config */TdWeapon.AIBurstInfo AimedBurst_Far;
	public/*(AISettings)*/ /*config */TdWeapon.AIReloadInfo ReloadReadyTime;
	public/*(AISettings)*/ /*protected config */float MinKeepFiringTime;
	public/*(AISettings)*/ /*protected config */float MaxKeepFiringTime;
	public /*protected config */float CombatRange_Max_CHASE;
	public /*protected config */float CombatRange_Preferred_CHASE;
	public/*(AISettings)*/ /*protected config */float MinKeepFiringTime_CHASE;
	public/*(AISettings)*/ /*protected config */float MaxKeepFiringTime_CHASE;
	public/*(AISettings)*/ /*protected config */TdWeapon.AIBurstInfo AimedBurst_Near_CHASE;
	public/*(AISettings)*/ /*protected config */TdWeapon.AIBurstInfo AimedBurst_Mid_CHASE;
	public/*(AISettings)*/ /*protected config */TdWeapon.AIBurstInfo AimedBurst_Far_CHASE;
	public/*(AISettings)*/ /*config */float PreReloadTime;
	public float ReloadWaitTime;
	public /*export editinline */DecalComponent DefaultDecalComponent;
	public Material DefaultDecalMaterial;
	public PhysicalMaterial DefaultImpactMaterial;
	public/*()*/ /*private config */float DecalStretchingMultiplier;
	public/*()*/ float DecalCullDistance;
	public /*transient */array<TdWeapon.PendingImpact> PendingImpacts;
	public StaticArray<TdEmitter, TdEmitter, TdEmitter>/*[3]*/ TracerEmitters;
	public int TracerEmitterIdx;
	public /*config */float RecoilAmount;
	public /*config */float RecoilRecoverTime;
	public /*config */float MinRecoil;
	public /*config */float MaxRecoil;
	public /*config */float KickbackAmount;
	public /*transient */array<MaterialInstanceConstant> LOIMaterialInstances;
	public /*transient */float LOILastUpdateEffectAmount;
	public /*transient */float LOIDisplayEffectTime;
	public name LOIparameter;
	public /*transient */float LOIOriginalDisplayEffectTime;
