...
public partial class Pawn_CriminalFixer : TdPlayerPawn/*
	...
	public Pawn_CriminalFixer()
	{
		...
		Mesh1p = Default__Pawn_CriminalFixer_TdPawnMesh1p;
		Mesh3p = Default__Pawn_CriminalFixer_TdPawnMesh3p;
		Mesh1pLowerBody = Default__Pawn_CriminalFixer_TdPawnMesh1pLowerBody;
		...
		Mesh = Default__Pawn_CriminalFixer_TdPawnMesh3p;
		...
		Components = new array</*export editinline */ActorComponent>
		{
			...
			Default__Pawn_CriminalFixer_TdPawnMesh3p,
			LoadAsset<CylinderComponent>("Default__Pawn_CriminalFixer.CollisionCylinder")/*Ref CylinderComponent'Default__Pawn_CriminalFixer.CollisionCylinder'*/,
