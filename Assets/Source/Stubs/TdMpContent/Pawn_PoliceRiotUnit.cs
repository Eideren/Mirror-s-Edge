...
public partial class Pawn_PoliceRiotUnit : TdPlayerPawn/*
	...
	public Pawn_PoliceRiotUnit()
	{
		...
		Mesh1p = Default__Pawn_PoliceRiotUnit_TdPawnMesh1p;
		Mesh3p = Default__Pawn_PoliceRiotUnit_TdPawnMesh3p;
		Mesh1pLowerBody = Default__Pawn_PoliceRiotUnit_TdPawnMesh1pLowerBody;
		bIsFemale = false;
		...
		Mesh = Default__Pawn_PoliceRiotUnit_TdPawnMesh3p;
		...
		Components = new array</*export editinline */ActorComponent>
		{
			...
			Default__Pawn_PoliceRiotUnit_TdPawnMesh3p,
			LoadAsset<CylinderComponent>("Default__Pawn_PoliceRiotUnit.CollisionCylinder")/*Ref CylinderComponent'Default__Pawn_PoliceRiotUnit.CollisionCylinder'*/,
