...
public partial class Pawn_CriminalProwler : TdPlayerPawn/*
	...
	public Pawn_CriminalProwler()
	{
		...
		Mesh1p = Default__Pawn_CriminalProwler_TdPawnMesh1p;
		Mesh3p = Default__Pawn_CriminalProwler_TdPawnMesh3p;
		Mesh1pLowerBody = Default__Pawn_CriminalProwler_TdPawnMesh1pLowerBody;
		...
		Mesh = Default__Pawn_CriminalProwler_TdPawnMesh3p;
		...
		Components = new array</*export editinline */ActorComponent>
		{
			...
			Default__Pawn_CriminalProwler_TdPawnMesh3p,
			LoadAsset<CylinderComponent>("Default__Pawn_CriminalProwler.CollisionCylinder")/*Ref CylinderComponent'Default__Pawn_CriminalProwler.CollisionCylinder'*/,
