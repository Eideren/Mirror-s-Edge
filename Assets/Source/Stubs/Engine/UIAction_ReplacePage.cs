...
public partial class UIAction_ReplacePage : UIAction_TabControl/*
	...
	{
		// Object Offset:0x00411C7C
		TabPageClass = ClassT<UITabPage>()/*Ref Class'UITabPage'*/;
		bFocusPage = true;
		VariableLinks = new array<SequenceOp.SeqVarLink>
		{
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkVar = (name)"None",
				PropertyName = (name)"PageToRemove",
				bWriteable = false,
				bHidden = false,
				MinVars = 1,
				MaxVars = 255,
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkVar = (name)"None",
				PropertyName = (name)"PageToInsert",
				bWriteable = false,
				bHidden = true,
				MinVars = 1,
				MaxVars = 255,
