...
public partial class UIAction_GetLoggedInPlayerCount : UIAction/*
		native
	...
	public UIAction_GetLoggedInPlayerCount()
	{
		...
		VariableLinks = new array<SequenceOp.SeqVarLink>
		{
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkVar = (name)"None",
				PropertyName = (name)"NumOnlineEnabled",
				bWriteable = true,
				bHidden = false,
				MinVars = 1,
				MaxVars = 255,
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkVar = (name)"None",
				PropertyName = (name)"NumLocalOnly",
				bWriteable = true,
				bHidden = false,
				MinVars = 1,
				MaxVars = 255,
			...
			new SequenceOp.SeqVarLink
			{
				...
				LinkVar = (name)"None",
				PropertyName = (name)"TotalLoggedIn",
				bWriteable = true,
				bHidden = false,
				MinVars = 1,
				MaxVars = 255,
